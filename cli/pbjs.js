...
exports.main = function main(args, callback) {
    ...
    var argv = minimist(args, {
        ...
        boolean: [ "create", "encode", "decode", "verify", "convert", "instance", "delimited", "beautify", "comments", "es6", "sparse", "keep-case", "force-long", "force-number", "force-enum-string", "force-message" ],
        default: {
            target: "json",
            create: true,
            encode: true,
    ...
    if (!files.length) {
        ...
        if (callback)
            ...
            process.stderr.write([
                ...
                "  --no-instance    Does not generate instance methods like toJSON (only static methods)",
